%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Changes made to standard template %%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{scrpage2} % Anpassungen für Kopf und Fußzeilen
...
$if(title)$
\subject{\vspace{-5\baselineskip}}
\title{$title$}
$endif$

$if(subject)$
\subject{\vspace{-5\baselineskip}$subject$}
$endif$
...
$if(date)$
\date{$date$\vspace{-0.5\baselineskip}}
$endif$


$if(version_number)$
\date{$date$}
\publishers{$version_number$} % \publishers setzt die Versionsnummer an das Ende der Seite
$endif$
